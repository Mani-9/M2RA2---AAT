        ...
        <div class="card mb-3 modcontainer " style="max-width: 540px;">
            ...
            <div class="card-body">
                <form action="agregar_cliente" method="post">
                    <div class="mb-3">
                        <label for="numIdCliente" class="form-label"><i class="bi bi-file-person-fill"></i>ID Cliente </label>
                    ...
                    <div class="mb-3">
                        <label for="txtApellido" class="form-label"><i class="bi bi-person-vcard"></i> Apellido</label>
                    ...
                    <div class="mb-3">
                        <label for="txtCorreoElectronico" class="form-label"><i class="bi bi-envelope-at-fill"></i> Correo electronico</label>
                    ...
                    <div class="mb-3">
                        <label for="numContrasena" class="form-label"><i class="bi bi-file-lock2"></i> Contraseña </label>
